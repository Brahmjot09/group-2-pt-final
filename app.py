...
default_bucket = "brahm-s3"
default_image = "image1.png"
...
def download(bucket = default_bucket, imageName = default_image):
    try:
        ...
        bgImagePath = os.path.join(imagesDir, "Seneca-College.webp")
        
        print(bucket, imageName)
        s3 = boto3.resource('s3')
        s3.Bucket(bucket).download_file(imageName, bgImagePath)
        return os.path.join(imagesDir, "Seneca-College.webp")
